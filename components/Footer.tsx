...
import { Terminal, Instagram, Globe, AtSign } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                <div className="flex flex-col justify-start">
                    <h4 className="font-black text-black mb-6 font-display text-xl tracking-wide uppercase border-b-4 border-brand-cyan inline-block self-start">Menu</h4>
            ...
            <div className="border-t-4 border-black pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex space-x-4">
                    <a href="#" aria-label="Website" className="text-black bg-brand-cyan p-2 border-2 border-black hover:bg-black hover:text-white hover:shadow-[4px_4px_0px_rgba(0,0,0,0.2)] transition-all">
                        <Globe className="w-5 h-5" />
                    </a>
                    <a href="#" aria-label="Instagram" className="text-black bg-brand-lime p-2 border-2 border-black hover:bg-black hover:text-white hover:shadow-[4px_4px_0px_rgba(0,0,0,0.2)] transition-all">
                        <Instagram className="w-5 h-5" />
                    </a>
                    <a href="#" aria-label="Threads" className="text-black bg-brand-purple p-2 border-2 border-black hover:bg-black hover:text-white hover:shadow-[4px_4px_0px_rgba(0,0,0,0.2)] transition-all">
